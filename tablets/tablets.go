...
// NewTabletInfoDirect creates a TabletInfo directly from pre-parsed fields,
// bypassing the builder's type-assertion and string-parsing logic.
func NewTabletInfoDirect(keyspace, table string, firstToken, lastToken int64, replicas []ReplicaInfo) (TabletInfo, error) {
