...
func TestGetHostPortMapping(t *testing.T) {
	...
	expected := []UnresolvedConnectionMetadata{}
	for id, hostID := range hostIDs {
		...
		for _, connectionID := range connectionIDs {
			...
			expected = append(expected, UnresolvedConnectionMetadata{
...
func sortUnresolvedHostPorts(xs []UnresolvedConnectionMetadata) {
