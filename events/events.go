...
func (t EventType) IsClusterEvent() bool {
	...
	case ClusterEventTypeSchemaChangeAggregate:
		return true
	case ClusterEventTypeConnectionMetadataChanged:
		return true
	default:
		return false
	}
...
func (t EventType) String() string {
	...
	case ClusterEventTypeConnectionMetadataChanged:
		return "CLUSTER<CONNECTION_METADATA_CHANGE>"
...
// ConnectionMetadataChangedEvent represents an aggregate schema change
type ConnectionMetadataChangedEvent struct {
...
// Type returns ClusterEventTypeConnectionMetadataChanged
func (e *ConnectionMetadataChangedEvent) Type() EventType {
	return ClusterEventTypeConnectionMetadataChanged
}

// String returns a string representation of the event
func (e *ConnectionMetadataChangedEvent) String() string {
