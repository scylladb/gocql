...
var unmarshalTests = []struct {
	...
	},
	{
		...
		Duration{},
		UnmarshalError("failed to unmarshal duration into *gocql.Duration: failed to extract nanoseconds: premature data end at 5"),
	},
	{
		NativeType{proto: 5, typ: TypeDuration},
	...
	},
	{
		...
		[]byte("\x89\xa2"),
		Duration{},
		UnmarshalError("failed to unmarshal duration into *gocql.Duration: failed to extract days: premature data end at 2"),
	},
	{
		NativeType{proto: 5, typ: TypeDuration},
		[]byte("\x89"),
