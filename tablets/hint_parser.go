...
// ParseHintDirect is a zero-reflection binary parser for the
...
func ParseHintDirect(data []byte, keyspace, table string) (TabletInfo, error) {
	...
	return NewTabletInfoDirect(keyspace, table, firstToken, lastToken, replicas)
}
